...
//import io.usethesource.capsule.TrieMap_Heterogeneous;
//
...
//		
//		FootprintUtils.writeToFile(Paths.get("map_sizes_heterogeneous_small.csv"), false, FootprintUtils.createLinearRange(0, 10_100, 100).stream()
//				.flatMap(size -> testOneConfiguration(size).stream()).collect(Collectors.toList()));		
//		
//		FootprintUtils.writeToFile(Paths.get("map_sizes_heterogeneous_medium.csv"), false, FootprintUtils.createLinearRange(10_000, 101_000, 1_000).stream()
//				.flatMap(size -> testOneConfiguration(size).stream()).collect(Collectors.toList()));		
//		
//		FootprintUtils.writeToFile(Paths.get("map_sizes_heterogeneous_large.csv"), false, FootprintUtils.createLinearRange(100_000, 8_100_000, 100_000).stream()
//				.flatMap(size -> testOneConfiguration(size).stream()).collect(Collectors.toList()));		
//		
//		FootprintUtils.writeToFile(Paths.get("map_sizes_heterogeneous_exponential.csv"), false, FootprintUtils.createExponentialRange(0, 24).stream()
//				.flatMap(size -> testOneConfiguration(size).stream()).collect(Collectors.toList()));
//	}
//		
...
////
////		String longName = String.format(
////				"io.usethesource.capsule.TrieMap_Heterogeneous[storePrimivesBoxed = %5s]",
////				storePrimivesBoxed);
//		
