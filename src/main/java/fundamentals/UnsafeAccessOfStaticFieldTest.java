  ...
  private static final long initializeStaticVariableOffset() {
    try {
      ...
      if (USE_EXTENDING_TEMPLATE) {
        staticVariableField =
            StaticVariableHolder.ExtendingTemplate.class.getDeclaredField("staticVariable");
      } else {
        staticVariableField =
            StaticVariableHolder.StandaloneTemplate.class.getDeclaredField("staticVariable");
      }
