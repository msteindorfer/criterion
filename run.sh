...
export VALUE_FACTORY_FACTORY="VF_CHAMP_MULTIMAP_HHAMT,VF_SCALA,VF_CLOJURE" ### VF_CHAMP_MAP_AS_MULTIMAP,VF_CHAMP_MULTIMAP_HCHAMP,VF_CHAMP_MULTIMAP_HHAMT ### VF_SCALA,VF_CLOJURE
