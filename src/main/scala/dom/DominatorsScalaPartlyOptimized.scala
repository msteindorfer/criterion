...
import _root_.io.usethesource.vallang.io.StandardTextWriter
import _root_.io.usethesource.vallang.io.old.{BinaryValueReader, BinaryValueWriter}
...
import io.usethesource.vallang.{IConstructor, IMap, ISet, ITuple, IValue, IValueFactory}
...
object DominatorsScalaPartlyOptimized {
  ...
  def testOne: IMap = {
    val vf: IValueFactory = io.usethesource.vallang.impl.persistent.ValueFactory.getInstance()
