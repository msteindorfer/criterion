...
//			
//			if (pattern == 0b01) {
//				filteredBitmap = (bitmap & 0x5555555555555555L) & (((bitmap >> 1) & 0x5555555555555555L) ^ 0x5555555555555555L);
//			} else if (pattern == 0b10) {
//				filteredBitmap = ((bitmap & 0x5555555555555555L) ^ 0x5555555555555555L) & ((bitmap >> 1) & 0x5555555555555555L); 
...
//			}
	...
	static class Map2To0NodeBase2 extends Base2 {
		...
		Map2To0NodeBase2(final long bitmap, final Object key1, final Object val1,
				final Object key2, final Object val2) {
			super(bitmap);
		...
		@SuppressWarnings("unused")
		private static final long[] arrayOffsets = arrayOffsets(Map2To0NodeBase2.class, new String[] {
				"key1", "val1", "key2", "val2" });
	...
	public static void main(String[] args) throws RunnerException {
		...
		Options opt = new OptionsBuilder()
				.include(".*" + BitmapIndexingBenchmark.class.getSimpleName() + ".*")
