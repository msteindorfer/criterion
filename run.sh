...
export VALUE_FACTORY_FACTORY="VF_CHAMP_MULTIMAP_HHAMT,VF_CHAMP_MULTIMAP_HHAMT_SPECIALIZED,VF_SCALA,VF_CLOJURE" ### VF_CHAMP_MAP_AS_MULTIMAP,VF_CHAMP_MULTIMAP_HCHAMP,VF_CHAMP_MULTIMAP_HHAMT ### VF_SCALA,VF_CLOJURE
...
######
export AGGREGATED_SETTINGS="-jvmArgsPrepend -Xms8g -jvmArgsPrepend -Xmx8g -jvmArgsPrepend -XX:-TieredCompilation -jvmArgsPrepend -XX:+UseCompressedOops -wi 20 -i 20 -f 1 -r 1 -gc true -rf csv -v NORMAL -foe true -bm avgt -p valueFactoryFactory=$VALUE_FACTORY_FACTORY -p sampleDataSelection=MATCH -p producer=PDB_INTEGER"
